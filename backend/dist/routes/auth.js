...
import { createSupabaseAnonClient, createSupabaseServiceClient, verifySupabaseJwt, } from "../lib/supabase.js";
...
function parseEmptyBody(body) {
    ...
    if (!parsed.success) {
        throw new AppError(400, "invalid_request", "This route does not accept a request body", parsed.error.flatten());
    }
}
...
async function revokeCurrentSession(accessToken, deps) {
